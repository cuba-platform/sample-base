...
public class CubasampleTestContainer extends TestContainer {

    public CubasampleTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/addon/samplebase/app.properties",
    ...
    public static class Common extends CubasampleTestContainer {

        public static final CubasampleTestContainer.Common INSTANCE = new CubasampleTestContainer.Common();
