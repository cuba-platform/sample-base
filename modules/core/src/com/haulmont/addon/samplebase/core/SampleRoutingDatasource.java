package com.haulmont.addon.samplebase.core;
 ...
 */
public class SampleRoutingDatasource extends AbstractDataSource implements ApplicationContextAware {
    ...
    private Logger log = LoggerFactory.getLogger(SampleRoutingDatasource.class);
